...
// die('This file is no longer used. The content manager has been rewritten as a Livewire component in content-manager.blade.php');
@endphp
...
<div>
    ...
    <div class="card card-body mb-5">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <input wire:model.live.debounce.400ms="search" type="text"
                   placeholder="Search title or body…" class="form-input">
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl z-50">
                ...
                <div class="px-6 py-5 space-y-5 max-h-[75vh] overflow-y-auto">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <label class="relative flex flex-col items-center gap-1 p-3 border-2 rounded-xl cursor-pointer transition-all
                    ...
                    <details class="border border-gray-200 rounded-lg">
                        <summary class="px-4 py-3 text-sm font-medium text-gray-700 cursor-pointer hover:bg-gray-50 rounded-lg">
                            SEO Settings (optional)
                        </summary>
                        <div class="px-4 pb-4 pt-2 space-y-3">
                            <div>
                                <label class="form-label">Meta Title</label>
                                <input wire:model="meta_title" type="text" class="form-input" placeholder="Override page title for search engines">
                            </div>
                            <div>
                ...
                <div class="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
                    ...
                    <button wire:click="save" wire:loading.attr="disabled" class="btn-primary">
                        <span wire:loading.remove wire:target="save">{{ $isEditing ? 'Update Content' : 'Create Content' }}</span>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full z-50 text-center">
            ...
            <p class="text-sm text-gray-500 mb-5">This content will be moved to trash. Associated files may be removed.</p>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="font-mono text-xs text-gray-500">{{ $item->menuItem?->path }}</span>
                        </td>
                        <td>
                            <span class="{{ $item->type_badge }}">{{ $item->type }}</span>
                        </td>
                        <td>
                            <button wire:click="toggleStatus({{ $item->id }})" class="focus:outline-none hover:opacity-80">
                        ...
                        <td class="text-right">
                            <div class="flex justify-end gap-1">
                                @if($item->menuItem)
                                <a href="{{ route('cms.item', [$item->menuItem->path, $item->slug]) }}"

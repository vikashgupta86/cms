...
class ContentServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (class_exists(Livewire::class)) {
            Livewire::component('admin.content-manager', \Modules\Content\Livewire\Admin\ContentManager::class);
        }

        $this->registerSeeders();

        // register commands
        $this->registerCommands('\Modules\Content\Console\Commands');
    }
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            base_path('Modules/Content/Config/config.php'), $this->moduleNameLower
        );
    }

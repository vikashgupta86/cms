...
class MenuItemComponent extends Component
{
    ...
    protected function populateFormFromMenuItem()
    {
        ...
        $this->file = $this->menuItem->file;
        $this->existingFile = $this->menuItem->file;
    }
    ...
    public function resetForm()
    {
        $this->reset([
            ...
            'custom_data', 'note', 'upload_file', 'content', 'file', 'existingFile',
        ]);
    ...
    protected function rules()
    {
        ...
        // Add file validation for file type
        if ($this->type === 'file') {
            if (!$this->existingFile) {
                $rules['upload_file'] = 'required|file|max:10240'; // 10MB max, required for new files
            } else {
                $rules['upload_file'] = 'nullable|file|max:10240'; // Optional for existing files
            }
        }

        // Add content validation for content type
    ...
    public function save()
    {
        ...
        try {
            ...
            if ($this->type === 'file' && $this->upload_file) {
            ...
            } elseif ($this->type === 'file' && !$this->upload_file && $this->existingFile) {

                ...
                <div class="row">
                    <div class="col-sm-6 col-12 mb-3">
                        <div class="form-group">
                            ...
                            <div wire:loading wire:target="upload_file" class="text-info mt-1">
                                Uploading...
                            </div>
                            ...
                            @if($existingFile)
                                <div class="mt-2">
                                    ...
                                    <a href="{{ Storage::disk('public')->url($existingFile) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="form-group" wire:ignore>
                                ...
                                <textarea id="content_editor" class="form-control" rows="6">
                                    {!! $this->content!!}
                                </textarea>
                            </div>
                                    ...
                                    $('#content_editor').summernote({
                                        ...
                                        callbacks: {
                                            onChange: function(contents) {
                                                @this.set('content_body', contents);
                                            }
                                        }
                                    });
                                }

                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("managehomepage::text.name")
                            </th>
                            <th>
                                @lang("managehomepage::text.slug")
                            </th>
                            <th>
                                @lang("managehomepage::text.updated_at")
                            </th>
                            <th>
                                @lang("managehomepage::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("managehomepage::text.action")
                            </th>
                        </tr>
                    </thead>
